...
public class WTLoadContainerView extends FrameLayout {
    ...
    public interface LoadContainerActionListener {
        void onNetWorkErrorViewClick(WTLoadContainerView view);

        void onNoDataViewClick(WTLoadContainerView view);
    }
            ...
            if (noDataView == null) {
                ...
                noDataView.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        if (mListener != null) {
                            mListener.onNoDataViewClick(WTLoadContainerView.this);
                        }
                    }
                });
            }
        ...
        if (show) {
            if (netErrorView == null) {
                ...
                netErrorView.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View v) {
                        if (mListener != null) {
                            mListener.onNetWorkErrorViewClick(WTLoadContainerView.this);
                        }
                    }
                });
            }
